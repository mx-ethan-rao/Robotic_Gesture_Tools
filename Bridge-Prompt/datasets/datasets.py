...
class RARP45(object):
    def __init__(self,
                 ...
                 small_test=False,
                 frame_dir='/data/mingxing/RARP-45/3_frames/',
                 label_dir='/data/mingxing/RARP-45/action_ids/',
                 class_dir='./gesture_mapping/rarp_45_mapping.json',
...
class Breakfast(object):
    def __init__(self,
                 root='/data/mingxing/Bridge_Prompt_data/breakfast',
                 transform=None, mode='val',
                 num_frames=16, ds=1, ol=0.5,
                 small_test=False,
                 frame_dir='/data/mingxing/Bridge_Prompt_data/breakfast/frames/',
                 label_dir='/data/mingxing/Bridge_Prompt_data/breakfast/action_ids/',
                 class_dir='/data/mingxing/Bridge_Prompt_data/breakfast/bf_mapping.json',
                 ext_class_dir='/data/mingxing/Bridge_Prompt_data/breakfast/bf_mapping_new.json',
                 pretrain=True, n_split=1):
        self.root = root
        self.transform = transform
        self.mode = mode
...
class Breakfast_feat(object):
    def __init__(self,
                 ...
                 small_test=False,
                 frame_dir='/data/mingxing/Bridge_Prompt_data/breakfast/frames/',
                 class_dir="/data/mingxing/Bridge_Prompt_data/breakfast/id2acti.txt",
                 label_dir="/data/mingxing/Bridge_Prompt_data/breakfast/acti2id.json",
        ...
        self.pretrain = pretrain
        self.n_split = n_split
        self.feat_dir = "/data/mingxing/Bridge_Prompt_data/breakfast/features_dir/breakfast_vit_acti_ls/"
        ...
        with open(self.class_dir, 'r') as f:
            for line in f.readlines():
                ...
                self.classes = {int(k): v for k, v in self.classes.items()}
        if self.mode == 'train':
            self.splt_dir = "/data/mingxing/Bridge_Prompt_data/breakfast/splits/train.split" + str(self.n_split) + ".bundle"
        else:
            self.splt_dir = "/data/mingxing/Bridge_Prompt_data/breakfast/splits/test.split" + str(self.n_split) + ".bundle"

        file_ptr = open(self.splt_dir, 'r')
        self.train_split = file_ptr.read().split('\n')[:-1]
        file_ptr.close()

        with open('/data/mingxing/Bridge_Prompt_data/breakfast/splits/breakfast_acti_vid2idx.json', 'r') as openf:
...
class Breakfast_acti(data.Dataset):
    def __init__(self,
                 ...
                 label_dir='/data/mingxing/Bridge_Prompt_data/breakfast/action_ids/',
                 class_dir='/data/mingxing/Bridge_Prompt_data/breakfast/bf_mapping.json',
                 id2acti_dir="/data/mingxing/Bridge_Prompt_data/breakfast/id2acti.txt",
                 acti2id_dir="/data/mingxing/Bridge_Prompt_data/breakfast/acti2id.json",
                 pretrain=True, n_split=1):
        self.root = root
        self.transform = transform
        self.mode = mode
...
class GTEA(data.Dataset):
    def __init__(self,
                 root='/data/mingxing/Bridge_Prompt_data/gtea',
                 transform=None, mode='val',
                 num_frames=16, ds=None, ol=None,
                 small_test=False,
                 frame_dir="/data/mingxing/Bridge_Prompt_data/gtea/frames/",
                 label_dir="/data/mingxing/Bridge_Prompt_data/gtea/action_descriptions_id/",
                 class_dir="/data/mingxing/Bridge_Prompt_data/gtea/gtea_id2act.json",
                 pretrain=True,
                 n_split=None):
        if ds is None:
            ds = [1, 2, 4]
...
class SALADS(data.Dataset):
    def __init__(self,
                 root='/data/mingxing/Bridge_Prompt_data/50salads',
                 transform=None, mode='val',
                 num_frames=16, ds=None, ol=None,
                 small_test=False,
                 frame_dir="/data/mingxing/Bridge_Prompt_data/50salads/frames/",
                 label_dir="/data/mingxing/Bridge_Prompt_data/50salads/action_descriptions_id/",
                 class_dir="/data/mingxing/Bridge_Prompt_data/50salads/mapping_adj.json",
                 pretrain=True,
                 n_split=1):
        if ds is None:
            ds = [24, 32]
