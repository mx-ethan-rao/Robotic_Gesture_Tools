...
class JIGSAWS(data_utl.Dataset):
    def __init__(self,
                 ...
                 small_test=False,
                 frame_dir='/data/mingxing/Bridge_Prompt_data/JIGSAWS_without_0/frames/',
                 label_dir='/data/mingxing/Bridge_Prompt_data/JIGSAWS_without_0/action_ids/',
                 class_dir='/data/mingxing/Bridge_Prompt_data/JIGSAWS_without_0/bf_mapping.json',
...
class JIGSAWS_FRAMES(data.Dataset):
    def __init__(self,
                ...
                save_feat_dir='/data/mingxing/JIGSAWS/i3d_without0_features',
                num_frames=32,
                transforms=None):
        self.root = root
        self.small_test = small_test
